(function() {
    ...
    $.fn.Upload = function(objparams) {
        ...
        // create box image
        single.prototype.createBoxImage = function() {
        ...
        single.prototype.btnRemoveEdit = function() {
            // create button edit, remove
        ...
        // trigger remove file
        single.prototype.triggerRemoveFile = function() {
            var _this = this;
        ...
        function modalEdit() {
            ...
            modalContent.className = modalClassName.modalContent;
            
            // Create button container
            const buttonContainer = document.createElement('div');
            buttonContainer.className = modalClassName.buttonContainer;
            
            // Create crop button
            const cropButton = document.createElement('button');
            cropButton.className = `${modalClassName.button} ${modalClassName.cropButton}`;
            cropButton.textContent = 'Crop';
            
            // Create rotate left button
            const rotateLeftButton = document.createElement('button');
            rotateLeftButton.className = `${modalClassName.button} ${modalClassName.rotateLeftButton}`;
            rotateLeftButton.textContent = 'Rotate Left';
            
            // Create rotate right button
            const rotateRightButton = document.createElement('button');
            rotateRightButton.className = `${modalClassName.button} ${modalClassName.rotateRightButton}`;
            ...
            closeButton.className = modalClassName.closeButton;
            ...
            imageContainer.className = modalClassName.imageContainer;
            
            // Create image element
            const image = document.createElement('img');
            image.className = modalClassName.editImage;
        ...
        // Create single instance of modal editor to be used throughout the plugin
        const editModal = new modalEdit();

        // trigger edit file
        single.prototype.triggerEditFile = function() {
            var _this = this;
